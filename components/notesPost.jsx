...
export const ElectroNotesPost = (props) => {
    ...
    const [notes, addNote, removeNote, clearNotes, editNote] = useFileFunctions("notes");
    ...
    if (editing == false) {
        return (
            <View style={[styles.notesPostMainView, {borderColor: primaryColor, height: windowHeight/8}]}>
                <TouchableOpacity style={styles.notesPostTextTouchable} onPress={handleNotePress}>
                    <Text style={[styles.notesPostText, {color: primaryColor}]} numberOfLines={6}>{props.note}</Text>
                </TouchableOpacity>
                <TouchableOpacity 
                    style={[styles.notesPostDeleteTouchable, {borderColor: primaryColor, backgroundColor: primaryColor}]} 
        ...
        return (
            <View style={[styles.notesPostMainView, {borderColor: primaryColor, height: windowHeight/8}]}>
                <TextInput 
                    style={[styles.notesPostTextTouchable, {color: primaryColor, padding: windowHeight*0.01}]} 
